...
const Achievements: React.FC = () => {
  ...
  return (
    <section id="achievements" className="py-20 bg-slate-100/30 dark:bg-navy-light/20">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          {achievements.map((achievement, index) => (
            <motion.div
              ...
              className="bg-white/80 dark:bg-navy-light/70 backdrop-blur-md rounded-2xl p-8 border border-slate-200/50 dark:border-white/10 hover:border-blue-500/30 transition-all duration-300 group"
            >
              {/* Category Badge */}
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                {achievement.metrics.map((metric, metricIndex) => (
                  <motion.div
                    ...
                    className="bg-slate-100/50 dark:bg-navy-light/40 rounded-lg p-4 border border-slate-200/30"
                  >
              ...
              {/* Technologies */}
              <div>
                <div className="text-sm font-semibold text-slate-900 dark:text-white mb-3">Technologies & Skills</div>
                <div className="flex flex-wrap gap-2">
                  {achievement.technologies.map((tech, techIndex) => (
                    <span
                      key={techIndex}
                      className="px-2 py-1 bg-slate-200/50 dark:bg-white/5 text-slate-600 dark:text-slate-300 rounded text-xs border border-slate-300/30 dark:border-white/10"
                    >
                      {tech}
                    </span>
                  ))}
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <div className="text-slate-600 dark:text-slate-300">Major Transformations</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-indigo-600 mb-2">$17M+</div>
              <div className="text-slate-600 dark:text-slate-300">Budget Managed</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-violet-600 mb-2">50M+</div>
              <div className="text-slate-600 dark:text-slate-300">Users Impacted</div>
            </div>
            <div className="text-center">
