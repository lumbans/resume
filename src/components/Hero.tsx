...
const Hero: React.FC = () => {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#f8fafc] dark:bg-navy"
    >
      ...
      />
      {/* Wash for text legibility (stronger on the left, behind the copy) */}
      <div
        aria-hidden="true"
      ...
      <div className="container mx-auto px-6 py-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              <div className="text-xl lg:text-2xl text-slate-600 dark:text-slate-300 font-light">
            ...
            >
              ...
              <a
                ...
                download
                className="px-8 py-3 border-2 border-slate-300 dark:border-white/20 text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-white/10 hover:text-slate-900 dark:hover:text-white font-semibold rounded-lg transition-all duration-300 text-center"
              >
                Download CV
              </a>
            </motion.div>
          ...
          >
            ...
            <div className="relative mx-auto w-80 h-80 lg:w-96 lg:h-96">
              ...
              <picture>
                ...
                <img
                  ...
                  decoding="async"
                  fetchPriority="high"
                  className="relative w-full h-full object-cover rounded-full border-4 border-white dark:border-navy-light shadow-2xl shadow-slate-300/60 dark:shadow-black/40"
                />
              </picture>
            </div>
            ...
            <motion.div
              ...
              className="absolute -top-4 -left-4 bg-white/80 dark:bg-navy-light/80 backdrop-blur-md rounded-lg p-4 border border-slate-200 dark:border-white/10 shadow-lg shadow-slate-300/40 dark:shadow-black/30"
            >
              <div className="flex items-center space-x-3">
                <Shield className="text-violet-600" size={24} />
                <div>
                  <div className="text-slate-900 dark:text-white font-semibold">99.95%</div>
                  <div className="text-slate-600 dark:text-slate-300 text-sm">Service Availability</div>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="absolute -bottom-4 -right-4 bg-white/80 dark:bg-navy-light/80 backdrop-blur-md rounded-lg p-4 border border-slate-200 dark:border-white/10 shadow-lg shadow-slate-300/40 dark:shadow-black/30"
            >
              <div className="flex items-center space-x-3">
                <Cloud className="text-cyan-600" size={24} />
                <div>
                  <div className="text-slate-900 dark:text-white font-semibold">30%</div>
                  <div className="text-slate-600 dark:text-slate-300 text-sm">Cloud Cost Saved</div>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="absolute top-1/2 -right-8 bg-white/80 dark:bg-navy-light/80 backdrop-blur-md rounded-lg p-4 border border-slate-200 dark:border-white/10 shadow-lg shadow-slate-300/40 dark:shadow-black/30"
            >
              <div className="flex items-center space-x-3">
                <Users className="text-indigo-600" size={24} />
                <div>
                  <div className="text-slate-900 dark:text-white font-semibold">70+</div>
                  <div className="text-slate-600 dark:text-slate-300 text-sm">Engineers Led</div>
                </div>
              </div>
            </motion.div>
          </motion.div>
        ...
        >
          <button
            ...
            className="text-slate-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-300"
          >
