      ...
      <div className="container mx-auto px-6">
        ...
        >
          <h2 className="text-4xl lg:text-5xl font-bold text-slate-900 mb-6">
            Certifications & <span className="bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-600 bg-clip-text text-transparent">Education</span>
          </h2>
              ...
              <div className="space-y-6">
                {certifications.map((cert, index) => (
                  <motion.div
                    ...
                    className="bg-slate-100/50 backdrop-blur-md rounded-xl p-6 border border-slate-200/50 hover:border-blue-500/30 transition-all duration-300"
                  >
                      ...
                      <div className="flex-grow">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {cert.skills.map((skill, skillIndex) => (
                            <span
                              key={skillIndex}
                              className="px-2 py-1 bg-slate-200/50 text-slate-600 rounded text-sm border border-slate-300/30"
                            >
                              {skill}
                            </span>
                          ))}
              ...
              <div className="space-y-4">
                {professionalDevelopment.map((item, index) => (
                  <motion.div
                    ...
                    className="bg-slate-100/50 rounded-lg p-4 border border-slate-200/50"
                  >
