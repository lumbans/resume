...
const Testimonials: React.FC = () => {
  ...
  return (
    <section id="recommendations" className="py-20 bg-white/50 dark:bg-navy-light/30">
      <div className="container mx-auto px-6">
        ...
        >
          <h2 className="text-4xl lg:text-5xl font-bold text-slate-900 dark:text-white mb-6">
            <span className="bg-gradient-to-r from-blue-600 via-violet-600 to-fuchsia-600 bg-clip-text text-transparent">Recommendations</span>
          </h2>
        ...
        {hasTestimonials ? (
          <div className="grid md:grid-cols-2 gap-8">
            {testimonials.map((t, index) => (
              <motion.div
                ...
                className="bg-white/80 dark:bg-navy-light/70 backdrop-blur-md rounded-2xl p-8 border border-slate-200/50 dark:border-white/10 hover:border-blue-500/30 transition-all duration-300 flex flex-col"
              >
                <Quote className="text-blue-600 mb-4" size={28} />
                <p className="text-slate-700 dark:text-slate-200 leading-relaxed mb-6 flex-grow">
                  &ldquo;{t.quote}&rdquo;
                </p>
                <div>
                  <div className="text-slate-900 dark:text-white font-semibold">{t.name}</div>
          ...
          >
            ...
            <p className="text-slate-700 dark:text-slate-200 text-lg leading-relaxed mb-8">
            ...
            <a
              ...
              className="inline-flex items-center space-x-2 px-8 py-3 bg-gradient-to-r from-blue-600 to-violet-600 hover:from-blue-700 hover:to-fuchsia-700 text-white font-semibold rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg shadow-indigo-900/30"
            >
              <Linkedin size={18} />
